...
#let freshman-hint = [
  ...
  - 关于户型、家具参数
    ...
    - *据猜测*，26 级本科新生将要继承回迁本部的 24 级的宿舍，入住沙河雁北上床下桌 4 人间。如有更新的情况，本材料会及时跟进。
      ...
      - 25 级入住当时还不存在的 6 人间的消息在#backlink("https://github.com/ArtveFlinaInBupt/dormitory/releases/tag/v250703")[本材料 2025 年 7 月 3 日公开发布的历史版本]中已有记载#super[（也可能更早就有，但是我最早只能找到这个版本的存档了！）]，不存在隐瞒和岁月史书，所以请相信我们。
