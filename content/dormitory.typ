...
#let 房型表格 = {
  ...
  table(
    ...
    table.header(
      [*所在校区*],
      [*宿舍楼*\ #text(size: .7em)[现行名 \[曾用名 (如有)\]#note()]],
      [*近 5 年\ 住户类型*],
...
#let 楼宇表格 = {
  ...
  table(
    ...
    table.header(
      ...
      tcell(rowspan: 2)[*宿舍楼*\ #text(size: .7em)[现行名 \[曾用名 (如有)\]#note(n: 2)]],
...
#let 表格注 = stack(
  ...
  ..notes(
    ...
    [学校于 2026 年夏天进行了一次草率、混乱的沙河宿舍大改名。其一，新名字会带来大量歧义；其二，学校的大量基础设施、信息化系统仍然在使用旧名字。因此，这之后负责任的资料都会同时给出两套名字，本材料也不例外。],
