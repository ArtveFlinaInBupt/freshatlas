...
一般认为#placement[入学考试的结果]与#level[第一学期四级报名资格和分级]有相关性。#placement[考]后一般不公布#placement[分数与排名]，公布#level[CET-4 资格]名单，并告知本人#level[分级]结果（在英语课#level[分班]上体现）。
...
必须指出，虽然#level[分级教学]客观存在，但#level[其]出发点和结果均非限制同学们的学习资源和分数——完全没有必要过于担心#level[分级]结果对自己未来的影响，实际上它也确实不会产生什么影响。
