...
#let 校区说明表格 = table(
  ...
  subtable[
    ...
    位于三环以内，紧邻北三环，距二环约 #qty[2][km]。周边有超多商圈。

    与#proper[北师大]隔街相邻；距#("北航", "央财", "交大", "法大", "电影学院").map(proper).join("、")、#proper[北大医学部]（#proper[北医三院]）*等*均短于 #qty[3][km]；距#proper[清华]、#proper[北大]短于 #qty[25][min] 车程。
